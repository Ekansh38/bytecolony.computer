...
(function () {
  ...
  var HELP_TOPICS = {
    help: [
      ...
      '',
      '  help nav       filesystem',
      '  help bg        background sim',
      '  help life      life sim',
      '  help boids     boid sim',
      '  help trail     mouse trail',
      '  help look      themes',
      '  help sys       system info',
      '  help fun       misc',
      '  help arcade    lua games',
      '  help <cmd>     any command',
    ].join('\n'),
    ...
    nav: [
      ...
      '  cd [path]      change dir',
      '  pwd            working dir',
      '  open <path>    go to page',
      '',
      'dirs: projects/  writing/  music/  games/',
    ].join('\n'),

    bg: [
      'background sim',
      '',
      '  bg [life|boids|combo|off]   mode',
      '  speed [life|boids] [0-100]  speed %',
      '  reset                       reinit',
      '  preset <name>               apply preset',
      '  params                      list all params',
      '  set <param> <val>           change param',
      '',
      'presets: default dusk soft aurora canvas',
      '         prism swarm ghost bloom midnight',
      '         ember chromatic fog paper drift',
    ].join('\n'),
    ...
    life: [
      ...
      '  spawn <pat> random [n]   random placement',
      '',
      'patterns: r-pentomino acorn gosper-gun',
      '  queen-bee pulsar pentadecathlon lwss hwss',
      '',
      'params:',
      '  life.cell      1-80    (7)',
    ...
    boids: [
      ...
      '  boids.speed       0-100%  (15)',
      '  boids.perception  1-2000  (55)',
    ...
    trail: [
      'mouse trail (life/combo mode)',
      '',
      '  move cursor over canvas to plant cells',
      '',
      'params:',
      '  trail.on     0/1     (1)',
      '  trail.size   1-3     (2) 1=dot 2=cross 3=wide',
      '  trail.glow   0-100%  (12)',
      '  trail.decay  0-100%  (80) 0=slow 100=fast',
    ].join('\n'),

    look: [
      'themes',
      '',
      '  colorscheme [name]   list or apply',
      '  color                current palette',
      '',
      'dark:  tokyo-night  gruvbox  kanagawa',
      'light: flexoki-light  rose-pine  ayu-light',
    ].join('\n'),
    ...
    arcade: [
      ...
      '',
      '  games                   list all',
      '  play <id>               run in terminal',
      '  source <id>             view code',
      '  scores <id> [n]         leaderboard',
      '  delete <id> <code>      delete game',
      '',
      '  editor                  new game',
      '  editor <id>             edit game',
      '',
  ...
  var HELP_CMDS = {
    ...
    preset: [
      ...
      '  dusk       combo  · purple glow + life      (dracula)',
      '  soft       combo  · gentle layers           (rose-pine)',
      '  aurora     combo  · rainbow + boids         (tokyo-night)',
      '  canvas     combo  · light rainbow           (github-light)',
      '  prism      life   · position rainbow',
      ...
      '  fog        life   · barely there',
      '  paper      life   · soft cells              (papercolor-light)',
      '  drift      boids  · calm flock',
    ].join('\n'),
